...
@WebServlet("/ModificarCantidadNecesariaProyectoGestorServlet")
public class ModificarCantidadNecesariaProyectoGestorServlet extends HttpServlet {
    private int codigo;
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        daoProyectosSQL.modificarCantidadNecesaria(codigo, Float.parseFloat(cantidadNecesaria));
